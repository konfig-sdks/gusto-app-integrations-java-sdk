...
public class GarnishmentsUpdateRequest {
  ...
  public GarnishmentsUpdateRequest() {
  }

  public GarnishmentsUpdateRequest description(String description) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The description of the garnishment.")
  ...
  public GarnishmentsUpdateRequest version(String version) {
  ...
  **/
  ...
  public GarnishmentsUpdateRequest active(Boolean active) {
  ...
  **/
  ...
  public GarnishmentsUpdateRequest amount(Float amount) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The amount of the garnishment. Either a percentage or a fixed dollar amount. Represented as a float, e.g. \"8.00\".")
  ...
  public GarnishmentsUpdateRequest courtOrdered(Boolean courtOrdered) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the garnishment is court ordered.")
  ...
  public GarnishmentsUpdateRequest times(Integer times) {
  ...
  **/
  ...
  public GarnishmentsUpdateRequest recurring(Boolean recurring) {
  ...
  **/
  ...
  public GarnishmentsUpdateRequest annualMaximum(Float annualMaximum) {
  ...
  **/
  ...
  public GarnishmentsUpdateRequest payPeriodMaximum(Float payPeriodMaximum) {
  ...
  **/
  ...
  public GarnishmentsUpdateRequest deductAsPercentage(Boolean deductAsPercentage) {
  ...
  **/
   ...
   * @return the GarnishmentsUpdateRequest instance itself
   */
  public GarnishmentsUpdateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GarnishmentsUpdateRequest garnishmentsUpdateRequest = (GarnishmentsUpdateRequest) o;
    return Objects.equals(this.description, garnishmentsUpdateRequest.description) &&
        Objects.equals(this.version, garnishmentsUpdateRequest.version) &&
        Objects.equals(this.active, garnishmentsUpdateRequest.active) &&
        Objects.equals(this.amount, garnishmentsUpdateRequest.amount) &&
        Objects.equals(this.courtOrdered, garnishmentsUpdateRequest.courtOrdered) &&
        Objects.equals(this.times, garnishmentsUpdateRequest.times) &&
        Objects.equals(this.recurring, garnishmentsUpdateRequest.recurring) &&
        Objects.equals(this.annualMaximum, garnishmentsUpdateRequest.annualMaximum) &&
        Objects.equals(this.payPeriodMaximum, garnishmentsUpdateRequest.payPeriodMaximum) &&
        Objects.equals(this.deductAsPercentage, garnishmentsUpdateRequest.deductAsPercentage)&&
        Objects.equals(this.additionalProperties, garnishmentsUpdateRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, version, active, amount, courtOrdered, times, recurring, annualMaximum, payPeriodMaximum, deductAsPercentage, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GarnishmentsUpdateRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GarnishmentsUpdateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GarnishmentsUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GarnishmentsUpdateRequest is not found in the empty JSON string", GarnishmentsUpdateRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GarnishmentsUpdateRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GarnishmentsUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GarnishmentsUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GarnishmentsUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GarnishmentsUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GarnishmentsUpdateRequest>() {
           @Override
           public void write(JsonWriter out, GarnishmentsUpdateRequest value) throws IOException {
           ...
           @Override
           public GarnishmentsUpdateRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GarnishmentsUpdateRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GarnishmentsUpdateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GarnishmentsUpdateRequest
  * @throws IOException if the JSON string is invalid with respect to GarnishmentsUpdateRequest
  */
  public static GarnishmentsUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GarnishmentsUpdateRequest.class);
  }

 /**
  * Convert an instance of GarnishmentsUpdateRequest to an JSON string
  *
  * @return JSON string
  */
