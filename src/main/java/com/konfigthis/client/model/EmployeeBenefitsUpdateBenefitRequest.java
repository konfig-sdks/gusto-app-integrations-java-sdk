...
public class EmployeeBenefitsUpdateBenefitRequest {
 ...
 public enum DeductionReducesTaxableIncomeEnum {
  ...
  public EmployeeBenefitsUpdateBenefitRequest() {
  }

  public EmployeeBenefitsUpdateBenefitRequest version(String version) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequest active(Boolean active) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequest employeeDeduction(String employeeDeduction) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequest deductAsPercentage(Boolean deductAsPercentage) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequest employeeDeductionAnnualMaximum(String employeeDeductionAnnualMaximum) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequest contribution(EmployeeBenefitsUpdateBenefitRequestContribution contribution) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequestContribution getContribution() {
    return contribution;
  }


  public void setContribution(EmployeeBenefitsUpdateBenefitRequestContribution contribution) {
  ...
  public EmployeeBenefitsUpdateBenefitRequest elective(Boolean elective) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequest companyContributionAnnualMaximum(String companyContributionAnnualMaximum) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequest limitOption(String limitOption) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequest catchUp(Boolean catchUp) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequest coverageAmount(String coverageAmount) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequest deductionReducesTaxableIncome(DeductionReducesTaxableIncomeEnum deductionReducesTaxableIncome) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequest coverageSalaryMultiplier(String coverageSalaryMultiplier) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequest companyContribution(String companyContribution) {
  ...
  **/
  ...
  public EmployeeBenefitsUpdateBenefitRequest contributeAsPercentage(Boolean contributeAsPercentage) {
  ...
  **/
   ...
   * @return the EmployeeBenefitsUpdateBenefitRequest instance itself
   */
  public EmployeeBenefitsUpdateBenefitRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeBenefitsUpdateBenefitRequest employeeBenefitsUpdateBenefitRequest = (EmployeeBenefitsUpdateBenefitRequest) o;
    return Objects.equals(this.version, employeeBenefitsUpdateBenefitRequest.version) &&
        Objects.equals(this.active, employeeBenefitsUpdateBenefitRequest.active) &&
        Objects.equals(this.employeeDeduction, employeeBenefitsUpdateBenefitRequest.employeeDeduction) &&
        Objects.equals(this.deductAsPercentage, employeeBenefitsUpdateBenefitRequest.deductAsPercentage) &&
        Objects.equals(this.employeeDeductionAnnualMaximum, employeeBenefitsUpdateBenefitRequest.employeeDeductionAnnualMaximum) &&
        Objects.equals(this.contribution, employeeBenefitsUpdateBenefitRequest.contribution) &&
        Objects.equals(this.elective, employeeBenefitsUpdateBenefitRequest.elective) &&
        Objects.equals(this.companyContributionAnnualMaximum, employeeBenefitsUpdateBenefitRequest.companyContributionAnnualMaximum) &&
        Objects.equals(this.limitOption, employeeBenefitsUpdateBenefitRequest.limitOption) &&
        Objects.equals(this.catchUp, employeeBenefitsUpdateBenefitRequest.catchUp) &&
        Objects.equals(this.coverageAmount, employeeBenefitsUpdateBenefitRequest.coverageAmount) &&
        Objects.equals(this.deductionReducesTaxableIncome, employeeBenefitsUpdateBenefitRequest.deductionReducesTaxableIncome) &&
        Objects.equals(this.coverageSalaryMultiplier, employeeBenefitsUpdateBenefitRequest.coverageSalaryMultiplier) &&
        Objects.equals(this.companyContribution, employeeBenefitsUpdateBenefitRequest.companyContribution) &&
        Objects.equals(this.contributeAsPercentage, employeeBenefitsUpdateBenefitRequest.contributeAsPercentage)&&
        Objects.equals(this.additionalProperties, employeeBenefitsUpdateBenefitRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeBenefitsUpdateBenefitRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeBenefitsUpdateBenefitRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeBenefitsUpdateBenefitRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeBenefitsUpdateBenefitRequest is not found in the empty JSON string", EmployeeBenefitsUpdateBenefitRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeBenefitsUpdateBenefitRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("contribution") != null && !jsonObj.get("contribution").isJsonNull()) {
        EmployeeBenefitsUpdateBenefitRequestContribution.validateJsonObject(jsonObj.getAsJsonObject("contribution"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeBenefitsUpdateBenefitRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeBenefitsUpdateBenefitRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeBenefitsUpdateBenefitRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeBenefitsUpdateBenefitRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeBenefitsUpdateBenefitRequest>() {
           @Override
           public void write(JsonWriter out, EmployeeBenefitsUpdateBenefitRequest value) throws IOException {
           ...
           @Override
           public EmployeeBenefitsUpdateBenefitRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeBenefitsUpdateBenefitRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeBenefitsUpdateBenefitRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeBenefitsUpdateBenefitRequest
  * @throws IOException if the JSON string is invalid with respect to EmployeeBenefitsUpdateBenefitRequest
  */
  public static EmployeeBenefitsUpdateBenefitRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeBenefitsUpdateBenefitRequest.class);
  }

 /**
  * Convert an instance of EmployeeBenefitsUpdateBenefitRequest to an JSON string
  *
  * @return JSON string
  */
