...
public class EmployeeBenefitsCreateBenefitRequest {
 ...
 public enum DeductionReducesTaxableIncomeEnum {
  ...
  private DeductionReducesTaxableIncomeEnum deductionReducesTaxableIncome;
  ...
  public EmployeeBenefitsCreateBenefitRequest() {
  }

  public EmployeeBenefitsCreateBenefitRequest companyBenefitUuid(String companyBenefitUuid) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The UUID of the company benefit.")
  ...
  public EmployeeBenefitsCreateBenefitRequest active(Boolean active) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRequest employeeDeduction(String employeeDeduction) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRequest deductAsPercentage(Boolean deductAsPercentage) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRequest employeeDeductionAnnualMaximum(String employeeDeductionAnnualMaximum) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRequest contribution(EmployeeBenefitsCreateBenefitRequestContribution contribution) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRequestContribution getContribution() {
    return contribution;
  }


  public void setContribution(EmployeeBenefitsCreateBenefitRequestContribution contribution) {
  ...
  public EmployeeBenefitsCreateBenefitRequest elective(Boolean elective) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRequest companyContributionAnnualMaximum(String companyContributionAnnualMaximum) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRequest limitOption(String limitOption) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRequest catchUp(Boolean catchUp) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRequest coverageAmount(String coverageAmount) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRequest coverageSalaryMultiplier(String coverageSalaryMultiplier) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRequest deductionReducesTaxableIncome(DeductionReducesTaxableIncomeEnum deductionReducesTaxableIncome) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the employee deduction reduces taxable income or not. Only valid for Group Term Life benefits. Note: when the value is not \"unset\", coverage amount and coverage salary multiplier are ignored.")
  ...
  public EmployeeBenefitsCreateBenefitRequest companyContribution(String companyContribution) {
  ...
  **/
  ...
  public EmployeeBenefitsCreateBenefitRequest contributeAsPercentage(Boolean contributeAsPercentage) {
  ...
  **/
   ...
   * @return the EmployeeBenefitsCreateBenefitRequest instance itself
   */
  public EmployeeBenefitsCreateBenefitRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeBenefitsCreateBenefitRequest employeeBenefitsCreateBenefitRequest = (EmployeeBenefitsCreateBenefitRequest) o;
    return Objects.equals(this.companyBenefitUuid, employeeBenefitsCreateBenefitRequest.companyBenefitUuid) &&
        Objects.equals(this.active, employeeBenefitsCreateBenefitRequest.active) &&
        Objects.equals(this.employeeDeduction, employeeBenefitsCreateBenefitRequest.employeeDeduction) &&
        Objects.equals(this.deductAsPercentage, employeeBenefitsCreateBenefitRequest.deductAsPercentage) &&
        Objects.equals(this.employeeDeductionAnnualMaximum, employeeBenefitsCreateBenefitRequest.employeeDeductionAnnualMaximum) &&
        Objects.equals(this.contribution, employeeBenefitsCreateBenefitRequest.contribution) &&
        Objects.equals(this.elective, employeeBenefitsCreateBenefitRequest.elective) &&
        Objects.equals(this.companyContributionAnnualMaximum, employeeBenefitsCreateBenefitRequest.companyContributionAnnualMaximum) &&
        Objects.equals(this.limitOption, employeeBenefitsCreateBenefitRequest.limitOption) &&
        Objects.equals(this.catchUp, employeeBenefitsCreateBenefitRequest.catchUp) &&
        Objects.equals(this.coverageAmount, employeeBenefitsCreateBenefitRequest.coverageAmount) &&
        Objects.equals(this.coverageSalaryMultiplier, employeeBenefitsCreateBenefitRequest.coverageSalaryMultiplier) &&
        Objects.equals(this.deductionReducesTaxableIncome, employeeBenefitsCreateBenefitRequest.deductionReducesTaxableIncome) &&
        Objects.equals(this.companyContribution, employeeBenefitsCreateBenefitRequest.companyContribution) &&
        Objects.equals(this.contributeAsPercentage, employeeBenefitsCreateBenefitRequest.contributeAsPercentage)&&
        Objects.equals(this.additionalProperties, employeeBenefitsCreateBenefitRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(companyBenefitUuid, active, employeeDeduction, deductAsPercentage, employeeDeductionAnnualMaximum, contribution, elective, companyContributionAnnualMaximum, limitOption, catchUp, coverageAmount, coverageSalaryMultiplier, deductionReducesTaxableIncome, companyContribution, contributeAsPercentage, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeBenefitsCreateBenefitRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("company_benefit_uuid");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeBenefitsCreateBenefitRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeBenefitsCreateBenefitRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeBenefitsCreateBenefitRequest is not found in the empty JSON string", EmployeeBenefitsCreateBenefitRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmployeeBenefitsCreateBenefitRequest.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("company_benefit_uuid").isJsonPrimitive()) {
      ...
      if (jsonObj.get("contribution") != null && !jsonObj.get("contribution").isJsonNull()) {
        EmployeeBenefitsCreateBenefitRequestContribution.validateJsonObject(jsonObj.getAsJsonObject("contribution"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeBenefitsCreateBenefitRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeBenefitsCreateBenefitRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeBenefitsCreateBenefitRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeBenefitsCreateBenefitRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeBenefitsCreateBenefitRequest>() {
           @Override
           public void write(JsonWriter out, EmployeeBenefitsCreateBenefitRequest value) throws IOException {
           ...
           @Override
           public EmployeeBenefitsCreateBenefitRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeBenefitsCreateBenefitRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeBenefitsCreateBenefitRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeBenefitsCreateBenefitRequest
  * @throws IOException if the JSON string is invalid with respect to EmployeeBenefitsCreateBenefitRequest
  */
  public static EmployeeBenefitsCreateBenefitRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeBenefitsCreateBenefitRequest.class);
  }

 /**
  * Convert an instance of EmployeeBenefitsCreateBenefitRequest to an JSON string
  *
  * @return JSON string
  */
