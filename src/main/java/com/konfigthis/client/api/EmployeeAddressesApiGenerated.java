...
public class EmployeeAddressesApiGenerated {
    ...
    private okhttp3.Call deleteEmployeeHomeAddressCall(String homeAddressUuid, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteEmployeeHomeAddressValidateBeforeCall(String homeAddressUuid, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'homeAddressUuid' is set
        if (homeAddressUuid == null) {
            throw new ApiException("Missing the required parameter 'homeAddressUuid' when calling deleteEmployeeHomeAddress(Async)");
        }

        return deleteEmployeeHomeAddressCall(homeAddressUuid, xGustoAPIVersion, _callback);

    }


    private ApiResponse<Void> deleteEmployeeHomeAddressWithHttpInfo(String homeAddressUuid, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = deleteEmployeeHomeAddressValidateBeforeCall(homeAddressUuid, xGustoAPIVersion, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call deleteEmployeeHomeAddressAsync(String homeAddressUuid, String xGustoAPIVersion, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteEmployeeHomeAddressValidateBeforeCall(homeAddressUuid, xGustoAPIVersion, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class DeleteEmployeeHomeAddressRequestBuilder {
        private final String homeAddressUuid;
        private String xGustoAPIVersion;

        private DeleteEmployeeHomeAddressRequestBuilder(String homeAddressUuid) {
         ...
         * Set xGustoAPIVersion
         * @param xGustoAPIVersion Determines the date-based API version associated with your API call. If none is provided, your application&#39;s [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used. (optional)
         * @return DeleteEmployeeHomeAddressRequestBuilder
         */
        public DeleteEmployeeHomeAddressRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        
        /**
         * Build call for deleteEmployeeHomeAddress
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute deleteEmployeeHomeAddress request
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        ...
        public void execute() throws ApiException {
            deleteEmployeeHomeAddressWithHttpInfo(homeAddressUuid, xGustoAPIVersion);
        }

        /**
         * Execute deleteEmployeeHomeAddress request with HTTP info returned
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return deleteEmployeeHomeAddressWithHttpInfo(homeAddressUuid, xGustoAPIVersion);
        }

        /**
         * Execute deleteEmployeeHomeAddress request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return deleteEmployeeHomeAddressAsync(homeAddressUuid, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public DeleteEmployeeHomeAddressRequestBuilder deleteEmployeeHomeAddress(String homeAddressUuid) throws IllegalArgumentException {
        if (homeAddressUuid == null) throw new IllegalArgumentException("\"homeAddressUuid\" is required but got null");
            

        return new DeleteEmployeeHomeAddressRequestBuilder(homeAddressUuid);
    }
    private okhttp3.Call deleteEmployeeWorkAddressCall(String workAddressUuid, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteEmployeeWorkAddressValidateBeforeCall(String workAddressUuid, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workAddressUuid' is set
        if (workAddressUuid == null) {
            throw new ApiException("Missing the required parameter 'workAddressUuid' when calling deleteEmployeeWorkAddress(Async)");
        }

        return deleteEmployeeWorkAddressCall(workAddressUuid, xGustoAPIVersion, _callback);

    }


    private ApiResponse<Void> deleteEmployeeWorkAddressWithHttpInfo(String workAddressUuid, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = deleteEmployeeWorkAddressValidateBeforeCall(workAddressUuid, xGustoAPIVersion, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call deleteEmployeeWorkAddressAsync(String workAddressUuid, String xGustoAPIVersion, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteEmployeeWorkAddressValidateBeforeCall(workAddressUuid, xGustoAPIVersion, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class DeleteEmployeeWorkAddressRequestBuilder {
        private final String workAddressUuid;
        private String xGustoAPIVersion;

        private DeleteEmployeeWorkAddressRequestBuilder(String workAddressUuid) {
         ...
         * Set xGustoAPIVersion
         * @param xGustoAPIVersion Determines the date-based API version associated with your API call. If none is provided, your application&#39;s [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used. (optional)
         * @return DeleteEmployeeWorkAddressRequestBuilder
         */
        public DeleteEmployeeWorkAddressRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        
        /**
         * Build call for deleteEmployeeWorkAddress
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute deleteEmployeeWorkAddress request
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public void execute() throws ApiException {
            deleteEmployeeWorkAddressWithHttpInfo(workAddressUuid, xGustoAPIVersion);
        }

        /**
         * Execute deleteEmployeeWorkAddress request with HTTP info returned
         * @return ApiResponse&lt;Void&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return deleteEmployeeWorkAddressWithHttpInfo(workAddressUuid, xGustoAPIVersion);
        }

        /**
         * Execute deleteEmployeeWorkAddress request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return deleteEmployeeWorkAddressAsync(workAddressUuid, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public DeleteEmployeeWorkAddressRequestBuilder deleteEmployeeWorkAddress(String workAddressUuid) throws IllegalArgumentException {
        if (workAddressUuid == null) throw new IllegalArgumentException("\"workAddressUuid\" is required but got null");
            

        return new DeleteEmployeeWorkAddressRequestBuilder(workAddressUuid);
    }
    private okhttp3.Call getCall(String workAddressUuid, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getValidateBeforeCall(String workAddressUuid, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'workAddressUuid' is set
        if (workAddressUuid == null) {
            throw new ApiException("Missing the required parameter 'workAddressUuid' when calling get(Async)");
        }

        return getCall(workAddressUuid, xGustoAPIVersion, _callback);

    }


    private ApiResponse<EmployeeWorkAddress> getWithHttpInfo(String workAddressUuid, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = getValidateBeforeCall(workAddressUuid, xGustoAPIVersion, null);
        Type localVarReturnType = new TypeToken<EmployeeWorkAddress>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAsync(String workAddressUuid, String xGustoAPIVersion, final ApiCallback<EmployeeWorkAddress> _callback) throws ApiException {

        okhttp3.Call localVarCall = getValidateBeforeCall(workAddressUuid, xGustoAPIVersion, _callback);
        Type localVarReturnType = new TypeToken<EmployeeWorkAddress>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class GetRequestBuilder {
        ...
        private GetRequestBuilder(String workAddressUuid) {
            this.workAddressUuid = workAddressUuid;
        }
         ...
         */
        public GetRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
         ...
         */
        public EmployeeWorkAddress execute() throws ApiException {
            ApiResponse<EmployeeWorkAddress> localVarResp = getWithHttpInfo(workAddressUuid, xGustoAPIVersion);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<EmployeeWorkAddress> executeWithHttpInfo() throws ApiException {
            return getWithHttpInfo(workAddressUuid, xGustoAPIVersion);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<EmployeeWorkAddress> _callback) throws ApiException {
            return getAsync(workAddressUuid, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public GetRequestBuilder get(String workAddressUuid) throws IllegalArgumentException {
        if (workAddressUuid == null) throw new IllegalArgumentException("\"workAddressUuid\" is required but got null");
            

        return new GetRequestBuilder(workAddressUuid);
    }
    ...
    private okhttp3.Call getWorkAddressesCall(String employeeId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getWorkAddressesValidateBeforeCall(String employeeId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling getWorkAddresses(Async)");
        }

        return getWorkAddressesCall(employeeId, xGustoAPIVersion, _callback);

    }


    private ApiResponse<List<EmployeeWorkAddress>> getWorkAddressesWithHttpInfo(String employeeId, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = getWorkAddressesValidateBeforeCall(employeeId, xGustoAPIVersion, null);
        Type localVarReturnType = new TypeToken<List<EmployeeWorkAddress>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getWorkAddressesAsync(String employeeId, String xGustoAPIVersion, final ApiCallback<List<EmployeeWorkAddress>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getWorkAddressesValidateBeforeCall(employeeId, xGustoAPIVersion, _callback);
        Type localVarReturnType = new TypeToken<List<EmployeeWorkAddress>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class GetWorkAddressesRequestBuilder {
        ...
        private GetWorkAddressesRequestBuilder(String employeeId) {
            this.employeeId = employeeId;
        }
         ...
         */
        public GetWorkAddressesRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        ...
        public List<EmployeeWorkAddress> execute() throws ApiException {
            ApiResponse<List<EmployeeWorkAddress>> localVarResp = getWorkAddressesWithHttpInfo(employeeId, xGustoAPIVersion);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<List<EmployeeWorkAddress>> executeWithHttpInfo() throws ApiException {
            return getWorkAddressesWithHttpInfo(employeeId, xGustoAPIVersion);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<EmployeeWorkAddress>> _callback) throws ApiException {
            return getWorkAddressesAsync(employeeId, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public GetWorkAddressesRequestBuilder getWorkAddresses(String employeeId) throws IllegalArgumentException {
        if (employeeId == null) throw new IllegalArgumentException("\"employeeId\" is required but got null");
            

        return new GetWorkAddressesRequestBuilder(employeeId);
    }
