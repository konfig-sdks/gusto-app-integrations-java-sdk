...
public class EmployeeEmploymentsApiGenerated {
    ...
    private okhttp3.Call deleteRehireCall(String employeeId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteRehireValidateBeforeCall(String employeeId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling deleteRehire(Async)");
        }

        return deleteRehireCall(employeeId, xGustoAPIVersion, _callback);

    }


    private ApiResponse<Void> deleteRehireWithHttpInfo(String employeeId, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = deleteRehireValidateBeforeCall(employeeId, xGustoAPIVersion, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call deleteRehireAsync(String employeeId, String xGustoAPIVersion, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteRehireValidateBeforeCall(employeeId, xGustoAPIVersion, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class DeleteRehireRequestBuilder {
        private final String employeeId;
        private String xGustoAPIVersion;

        private DeleteRehireRequestBuilder(String employeeId) {
            this.employeeId = employeeId;
        }
         ...
         * Set xGustoAPIVersion
         * @param xGustoAPIVersion Determines the date-based API version associated with your API call. If none is provided, your application&#39;s [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used. (optional)
         * @return DeleteRehireRequestBuilder
         */
        public DeleteRehireRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        
        /**
         * Build call for deleteRehire
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        public void execute() throws ApiException {
            deleteRehireWithHttpInfo(employeeId, xGustoAPIVersion);
        }

        /**
         * Execute deleteRehire request with HTTP info returned
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return deleteRehireWithHttpInfo(employeeId, xGustoAPIVersion);
        }

        /**
         * Execute deleteRehire request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return deleteRehireAsync(employeeId, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public DeleteRehireRequestBuilder deleteRehire(String employeeId) throws IllegalArgumentException {
        if (employeeId == null) throw new IllegalArgumentException("\"employeeId\" is required but got null");
            

        return new DeleteRehireRequestBuilder(employeeId);
    }
    ...
    private okhttp3.Call getRehireInfoCall(String employeeId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getRehireInfoValidateBeforeCall(String employeeId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling getRehireInfo(Async)");
        }

        return getRehireInfoCall(employeeId, xGustoAPIVersion, _callback);

    }


    private ApiResponse<Rehire> getRehireInfoWithHttpInfo(String employeeId, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = getRehireInfoValidateBeforeCall(employeeId, xGustoAPIVersion, null);
        Type localVarReturnType = new TypeToken<Rehire>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getRehireInfoAsync(String employeeId, String xGustoAPIVersion, final ApiCallback<Rehire> _callback) throws ApiException {

        okhttp3.Call localVarCall = getRehireInfoValidateBeforeCall(employeeId, xGustoAPIVersion, _callback);
        Type localVarReturnType = new TypeToken<Rehire>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetRehireInfoRequestBuilder {
        private final String employeeId;
        private String xGustoAPIVersion;

        private GetRehireInfoRequestBuilder(String employeeId) {
            this.employeeId = employeeId;
        }
         ...
         * Set xGustoAPIVersion
         * @param xGustoAPIVersion Determines the date-based API version associated with your API call. If none is provided, your application&#39;s [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used. (optional)
         * @return GetRehireInfoRequestBuilder
         */
        public GetRehireInfoRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        
        /**
         * Build call for getRehireInfo
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public Rehire execute() throws ApiException {
            ApiResponse<Rehire> localVarResp = getRehireInfoWithHttpInfo(employeeId, xGustoAPIVersion);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getRehireInfo request with HTTP info returned
         * @return ApiResponse&lt;Rehire&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<Rehire> executeWithHttpInfo() throws ApiException {
            return getRehireInfoWithHttpInfo(employeeId, xGustoAPIVersion);
        }

        /**
         * Execute getRehireInfo request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Rehire> _callback) throws ApiException {
            return getRehireInfoAsync(employeeId, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public GetRehireInfoRequestBuilder getRehireInfo(String employeeId) throws IllegalArgumentException {
        if (employeeId == null) throw new IllegalArgumentException("\"employeeId\" is required but got null");
            

        return new GetRehireInfoRequestBuilder(employeeId);
    }
    private okhttp3.Call listTerminationsForEmployeeCall(String employeeId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listTerminationsForEmployeeValidateBeforeCall(String employeeId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'employeeId' is set
        if (employeeId == null) {
            throw new ApiException("Missing the required parameter 'employeeId' when calling listTerminationsForEmployee(Async)");
        }

        return listTerminationsForEmployeeCall(employeeId, xGustoAPIVersion, _callback);

    }


    private ApiResponse<List<Termination>> listTerminationsForEmployeeWithHttpInfo(String employeeId, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = listTerminationsForEmployeeValidateBeforeCall(employeeId, xGustoAPIVersion, null);
        Type localVarReturnType = new TypeToken<List<Termination>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listTerminationsForEmployeeAsync(String employeeId, String xGustoAPIVersion, final ApiCallback<List<Termination>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listTerminationsForEmployeeValidateBeforeCall(employeeId, xGustoAPIVersion, _callback);
        Type localVarReturnType = new TypeToken<List<Termination>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListTerminationsForEmployeeRequestBuilder {
        private final String employeeId;
        private String xGustoAPIVersion;

        private ListTerminationsForEmployeeRequestBuilder(String employeeId) {
            this.employeeId = employeeId;
        }
         ...
         * Set xGustoAPIVersion
         * @param xGustoAPIVersion Determines the date-based API version associated with your API call. If none is provided, your application&#39;s [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used. (optional)
         * @return ListTerminationsForEmployeeRequestBuilder
         */
        public ListTerminationsForEmployeeRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        
        /**
         * Build call for listTerminationsForEmployee
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute listTerminationsForEmployee request
        ...
        public List<Termination> execute() throws ApiException {
            ApiResponse<List<Termination>> localVarResp = listTerminationsForEmployeeWithHttpInfo(employeeId, xGustoAPIVersion);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listTerminationsForEmployee request with HTTP info returned
        ...
        public ApiResponse<List<Termination>> executeWithHttpInfo() throws ApiException {
            return listTerminationsForEmployeeWithHttpInfo(employeeId, xGustoAPIVersion);
        }

        /**
         * Execute listTerminationsForEmployee request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<Termination>> _callback) throws ApiException {
            return listTerminationsForEmployeeAsync(employeeId, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public ListTerminationsForEmployeeRequestBuilder listTerminationsForEmployee(String employeeId) throws IllegalArgumentException {
        if (employeeId == null) throw new IllegalArgumentException("\"employeeId\" is required but got null");
            

        return new ListTerminationsForEmployeeRequestBuilder(employeeId);
    }
