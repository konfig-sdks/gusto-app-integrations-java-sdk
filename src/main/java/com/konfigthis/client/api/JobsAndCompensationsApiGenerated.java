...
public class JobsAndCompensationsApiGenerated {
    ...
    private okhttp3.Call deleteCompensationCall(String compensationId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteCompensationValidateBeforeCall(String compensationId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'compensationId' is set
        if (compensationId == null) {
            throw new ApiException("Missing the required parameter 'compensationId' when calling deleteCompensation(Async)");
        }

        return deleteCompensationCall(compensationId, xGustoAPIVersion, _callback);

    }


    private ApiResponse<Void> deleteCompensationWithHttpInfo(String compensationId, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = deleteCompensationValidateBeforeCall(compensationId, xGustoAPIVersion, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call deleteCompensationAsync(String compensationId, String xGustoAPIVersion, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteCompensationValidateBeforeCall(compensationId, xGustoAPIVersion, _callback);
    ...
    public class DeleteCompensationRequestBuilder {
        ...
        private DeleteCompensationRequestBuilder(String compensationId) {
         ...
         */
        public DeleteCompensationRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        ...
        public void execute() throws ApiException {
            deleteCompensationWithHttpInfo(compensationId, xGustoAPIVersion);
        }
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return deleteCompensationWithHttpInfo(compensationId, xGustoAPIVersion);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return deleteCompensationAsync(compensationId, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public DeleteCompensationRequestBuilder deleteCompensation(String compensationId) throws IllegalArgumentException {
        if (compensationId == null) throw new IllegalArgumentException("\"compensationId\" is required but got null");
            

        return new DeleteCompensationRequestBuilder(compensationId);
    }
    private okhttp3.Call deleteSpecificJobCall(String jobId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteSpecificJobValidateBeforeCall(String jobId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'jobId' is set
        if (jobId == null) {
            throw new ApiException("Missing the required parameter 'jobId' when calling deleteSpecificJob(Async)");
        }

        return deleteSpecificJobCall(jobId, xGustoAPIVersion, _callback);

    }


    private ApiResponse<Void> deleteSpecificJobWithHttpInfo(String jobId, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = deleteSpecificJobValidateBeforeCall(jobId, xGustoAPIVersion, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call deleteSpecificJobAsync(String jobId, String xGustoAPIVersion, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteSpecificJobValidateBeforeCall(jobId, xGustoAPIVersion, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class DeleteSpecificJobRequestBuilder {
        private final String jobId;
        private String xGustoAPIVersion;

        private DeleteSpecificJobRequestBuilder(String jobId) {
            this.jobId = jobId;
        }
         ...
         * Set xGustoAPIVersion
         * @param xGustoAPIVersion Determines the date-based API version associated with your API call. If none is provided, your application&#39;s [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used. (optional)
         * @return DeleteSpecificJobRequestBuilder
         */
        public DeleteSpecificJobRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        
        /**
         * Build call for deleteSpecificJob
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute deleteSpecificJob request
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public void execute() throws ApiException {
            deleteSpecificJobWithHttpInfo(jobId, xGustoAPIVersion);
        }

        /**
         * Execute deleteSpecificJob request with HTTP info returned
         * @return ApiResponse&lt;Void&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return deleteSpecificJobWithHttpInfo(jobId, xGustoAPIVersion);
        }

        /**
         * Execute deleteSpecificJob request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return deleteSpecificJobAsync(jobId, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public DeleteSpecificJobRequestBuilder deleteSpecificJob(String jobId) throws IllegalArgumentException {
        if (jobId == null) throw new IllegalArgumentException("\"jobId\" is required but got null");
            

        return new DeleteSpecificJobRequestBuilder(jobId);
    }
    ...
    private okhttp3.Call getCompensationsByJobIdCall(String jobId, Double page, Double per, String include, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCompensationsByJobIdValidateBeforeCall(String jobId, Double page, Double per, String include, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'jobId' is set
        if (jobId == null) {
            throw new ApiException("Missing the required parameter 'jobId' when calling getCompensationsByJobId(Async)");
        }

        return getCompensationsByJobIdCall(jobId, page, per, include, xGustoAPIVersion, _callback);

    }


    private ApiResponse<List<Compensation>> getCompensationsByJobIdWithHttpInfo(String jobId, Double page, Double per, String include, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = getCompensationsByJobIdValidateBeforeCall(jobId, page, per, include, xGustoAPIVersion, null);
        Type localVarReturnType = new TypeToken<List<Compensation>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getCompensationsByJobIdAsync(String jobId, Double page, Double per, String include, String xGustoAPIVersion, final ApiCallback<List<Compensation>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCompensationsByJobIdValidateBeforeCall(jobId, page, per, include, xGustoAPIVersion, _callback);
        Type localVarReturnType = new TypeToken<List<Compensation>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetCompensationsByJobIdRequestBuilder {
        private final String jobId;
        private Double page;
        private Double per;
        ...
        private GetCompensationsByJobIdRequestBuilder(String jobId) {
            this.jobId = jobId;
        }
         ...
         * @return GetCompensationsByJobIdRequestBuilder
         */
        public GetCompensationsByJobIdRequestBuilder page(Double page) {
            this.page = page;
            return this;
        }
         ...
         * @return GetCompensationsByJobIdRequestBuilder
         */
        public GetCompensationsByJobIdRequestBuilder per(Double per) {
            this.per = per;
            return this;
        }
         ...
         * @return GetCompensationsByJobIdRequestBuilder
         */
        public GetCompensationsByJobIdRequestBuilder include(String include) {
         ...
         * @return GetCompensationsByJobIdRequestBuilder
         */
        public GetCompensationsByJobIdRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        
        /**
         * Build call for getCompensationsByJobId
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute getCompensationsByJobId request
        ...
        public List<Compensation> execute() throws ApiException {
            ApiResponse<List<Compensation>> localVarResp = getCompensationsByJobIdWithHttpInfo(jobId, page, per, include, xGustoAPIVersion);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getCompensationsByJobId request with HTTP info returned
        ...
        public ApiResponse<List<Compensation>> executeWithHttpInfo() throws ApiException {
            return getCompensationsByJobIdWithHttpInfo(jobId, page, per, include, xGustoAPIVersion);
        }

        /**
         * Execute getCompensationsByJobId request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<Compensation>> _callback) throws ApiException {
            return getCompensationsByJobIdAsync(jobId, page, per, include, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public GetCompensationsByJobIdRequestBuilder getCompensationsByJobId(String jobId) throws IllegalArgumentException {
        if (jobId == null) throw new IllegalArgumentException("\"jobId\" is required but got null");
            

        return new GetCompensationsByJobIdRequestBuilder(jobId);
    }
    private okhttp3.Call getDetailsCall(String jobId, String include, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDetailsValidateBeforeCall(String jobId, String include, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'jobId' is set
        if (jobId == null) {
            throw new ApiException("Missing the required parameter 'jobId' when calling getDetails(Async)");
        }

        return getDetailsCall(jobId, include, xGustoAPIVersion, _callback);

    }


    private ApiResponse<Job> getDetailsWithHttpInfo(String jobId, String include, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = getDetailsValidateBeforeCall(jobId, include, xGustoAPIVersion, null);
        Type localVarReturnType = new TypeToken<Job>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getDetailsAsync(String jobId, String include, String xGustoAPIVersion, final ApiCallback<Job> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDetailsValidateBeforeCall(jobId, include, xGustoAPIVersion, _callback);
        Type localVarReturnType = new TypeToken<Job>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class GetDetailsRequestBuilder {
        ...
        private GetDetailsRequestBuilder(String jobId) {
            this.jobId = jobId;
        }
         ...
         */
        public Job execute() throws ApiException {
            ApiResponse<Job> localVarResp = getDetailsWithHttpInfo(jobId, include, xGustoAPIVersion);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<Job> executeWithHttpInfo() throws ApiException {
            return getDetailsWithHttpInfo(jobId, include, xGustoAPIVersion);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Job> _callback) throws ApiException {
            return getDetailsAsync(jobId, include, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public GetDetailsRequestBuilder getDetails(String jobId) throws IllegalArgumentException {
        if (jobId == null) throw new IllegalArgumentException("\"jobId\" is required but got null");
            

        return new GetDetailsRequestBuilder(jobId);
    }
