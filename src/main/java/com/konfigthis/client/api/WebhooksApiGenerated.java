...
import com.konfigthis.client.model.WebhooksUpdateSubscriptionByUuidRequest;
...
public class WebhooksApiGenerated {
    ...
    private okhttp3.Call getSubscriptionByUuidCall(String webhookSubscriptionUuid, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSubscriptionByUuidValidateBeforeCall(String webhookSubscriptionUuid, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'webhookSubscriptionUuid' is set
        if (webhookSubscriptionUuid == null) {
            throw new ApiException("Missing the required parameter 'webhookSubscriptionUuid' when calling getSubscriptionByUuid(Async)");
        }

        return getSubscriptionByUuidCall(webhookSubscriptionUuid, xGustoAPIVersion, _callback);

    }


    private ApiResponse<WebhookSubscription> getSubscriptionByUuidWithHttpInfo(String webhookSubscriptionUuid, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = getSubscriptionByUuidValidateBeforeCall(webhookSubscriptionUuid, xGustoAPIVersion, null);
        Type localVarReturnType = new TypeToken<WebhookSubscription>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSubscriptionByUuidAsync(String webhookSubscriptionUuid, String xGustoAPIVersion, final ApiCallback<WebhookSubscription> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSubscriptionByUuidValidateBeforeCall(webhookSubscriptionUuid, xGustoAPIVersion, _callback);
        Type localVarReturnType = new TypeToken<WebhookSubscription>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class GetSubscriptionByUuidRequestBuilder {
        private final String webhookSubscriptionUuid;
        private String xGustoAPIVersion;

        private GetSubscriptionByUuidRequestBuilder(String webhookSubscriptionUuid) {
            this.webhookSubscriptionUuid = webhookSubscriptionUuid;
        }
         ...
         * Set xGustoAPIVersion
         * @param xGustoAPIVersion Determines the date-based API version associated with your API call. If none is provided, your application&#39;s [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used. (optional)
         * @return GetSubscriptionByUuidRequestBuilder
         */
        public GetSubscriptionByUuidRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        
        /**
         * Build call for getSubscriptionByUuid
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute getSubscriptionByUuid request
         * @return WebhookSubscription
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public WebhookSubscription execute() throws ApiException {
            ApiResponse<WebhookSubscription> localVarResp = getSubscriptionByUuidWithHttpInfo(webhookSubscriptionUuid, xGustoAPIVersion);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getSubscriptionByUuid request with HTTP info returned
         * @return ApiResponse&lt;WebhookSubscription&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
         ...
         */
        public ApiResponse<WebhookSubscription> executeWithHttpInfo() throws ApiException {
            return getSubscriptionByUuidWithHttpInfo(webhookSubscriptionUuid, xGustoAPIVersion);
        }

        /**
         * Execute getSubscriptionByUuid request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<WebhookSubscription> _callback) throws ApiException {
            return getSubscriptionByUuidAsync(webhookSubscriptionUuid, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public GetSubscriptionByUuidRequestBuilder getSubscriptionByUuid(String webhookSubscriptionUuid) throws IllegalArgumentException {
        if (webhookSubscriptionUuid == null) throw new IllegalArgumentException("\"webhookSubscriptionUuid\" is required but got null");
            

        return new GetSubscriptionByUuidRequestBuilder(webhookSubscriptionUuid);
    }
    ...
    private okhttp3.Call updateSubscriptionByUuidCall(String webhookSubscriptionUuid, String xGustoAPIVersion, WebhooksUpdateSubscriptionByUuidRequest webhooksUpdateSubscriptionByUuidRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = webhooksUpdateSubscriptionByUuidRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateSubscriptionByUuidValidateBeforeCall(String webhookSubscriptionUuid, String xGustoAPIVersion, WebhooksUpdateSubscriptionByUuidRequest webhooksUpdateSubscriptionByUuidRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'webhookSubscriptionUuid' is set
        if (webhookSubscriptionUuid == null) {
            throw new ApiException("Missing the required parameter 'webhookSubscriptionUuid' when calling updateSubscriptionByUuid(Async)");
        }

        return updateSubscriptionByUuidCall(webhookSubscriptionUuid, xGustoAPIVersion, webhooksUpdateSubscriptionByUuidRequest, _callback);

    }


    private ApiResponse<WebhookSubscription> updateSubscriptionByUuidWithHttpInfo(String webhookSubscriptionUuid, String xGustoAPIVersion, WebhooksUpdateSubscriptionByUuidRequest webhooksUpdateSubscriptionByUuidRequest) throws ApiException {
        okhttp3.Call localVarCall = updateSubscriptionByUuidValidateBeforeCall(webhookSubscriptionUuid, xGustoAPIVersion, webhooksUpdateSubscriptionByUuidRequest, null);
        Type localVarReturnType = new TypeToken<WebhookSubscription>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateSubscriptionByUuidAsync(String webhookSubscriptionUuid, String xGustoAPIVersion, WebhooksUpdateSubscriptionByUuidRequest webhooksUpdateSubscriptionByUuidRequest, final ApiCallback<WebhookSubscription> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateSubscriptionByUuidValidateBeforeCall(webhookSubscriptionUuid, xGustoAPIVersion, webhooksUpdateSubscriptionByUuidRequest, _callback);
        Type localVarReturnType = new TypeToken<WebhookSubscription>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateSubscriptionByUuidRequestBuilder {
        private final List<String> subscriptionTypes;
        private final String webhookSubscriptionUuid;
        private String xGustoAPIVersion;

        private UpdateSubscriptionByUuidRequestBuilder(List<String> subscriptionTypes, String webhookSubscriptionUuid) {
            this.subscriptionTypes = subscriptionTypes;
            this.webhookSubscriptionUuid = webhookSubscriptionUuid;
        }
         ...
         * Set xGustoAPIVersion
         * @param xGustoAPIVersion Determines the date-based API version associated with your API call. If none is provided, your application&#39;s [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used. (optional)
         * @return UpdateSubscriptionByUuidRequestBuilder
         */
        public UpdateSubscriptionByUuidRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        
        /**
         * Build call for updateSubscriptionByUuid
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            WebhooksUpdateSubscriptionByUuidRequest webhooksUpdateSubscriptionByUuidRequest = buildBodyParams();
            return updateSubscriptionByUuidCall(webhookSubscriptionUuid, xGustoAPIVersion, webhooksUpdateSubscriptionByUuidRequest, _callback);
        }

        private WebhooksUpdateSubscriptionByUuidRequest buildBodyParams() {
            WebhooksUpdateSubscriptionByUuidRequest webhooksUpdateSubscriptionByUuidRequest = new WebhooksUpdateSubscriptionByUuidRequest();
            if (this.subscriptionTypes != null)
            webhooksUpdateSubscriptionByUuidRequest.subscriptionTypes(WebhooksUpdateSubscriptionByUuidRequest.SubscriptionTypesEnum.fromValue(this.subscriptionTypes));
            return webhooksUpdateSubscriptionByUuidRequest;
        }

        /**
         * Execute updateSubscriptionByUuid request
         * @return WebhookSubscription
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public WebhookSubscription execute() throws ApiException {
            WebhooksUpdateSubscriptionByUuidRequest webhooksUpdateSubscriptionByUuidRequest = buildBodyParams();
            ApiResponse<WebhookSubscription> localVarResp = updateSubscriptionByUuidWithHttpInfo(webhookSubscriptionUuid, xGustoAPIVersion, webhooksUpdateSubscriptionByUuidRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateSubscriptionByUuid request with HTTP info returned
         * @return ApiResponse&lt;WebhookSubscription&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<WebhookSubscription> executeWithHttpInfo() throws ApiException {
            WebhooksUpdateSubscriptionByUuidRequest webhooksUpdateSubscriptionByUuidRequest = buildBodyParams();
            return updateSubscriptionByUuidWithHttpInfo(webhookSubscriptionUuid, xGustoAPIVersion, webhooksUpdateSubscriptionByUuidRequest);
        }

        /**
         * Execute updateSubscriptionByUuid request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<WebhookSubscription> _callback) throws ApiException {
            WebhooksUpdateSubscriptionByUuidRequest webhooksUpdateSubscriptionByUuidRequest = buildBodyParams();
            return updateSubscriptionByUuidAsync(webhookSubscriptionUuid, xGustoAPIVersion, webhooksUpdateSubscriptionByUuidRequest, _callback);
        }
    }
     ...
     */
    public UpdateSubscriptionByUuidRequestBuilder updateSubscriptionByUuid(List<String> subscriptionTypes, String webhookSubscriptionUuid) throws IllegalArgumentException {
        if (subscriptionTypes == null) throw new IllegalArgumentException("\"subscriptionTypes\" is required but got null");
        if (webhookSubscriptionUuid == null) throw new IllegalArgumentException("\"webhookSubscriptionUuid\" is required but got null");
            

        return new UpdateSubscriptionByUuidRequestBuilder(subscriptionTypes, webhookSubscriptionUuid);
    }
