...
import com.konfigthis.client.model.GarnishmentsUpdateRequest;
...
public class GarnishmentsApiGenerated {
    ...
    private okhttp3.Call getCall(String garnishmentId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getValidateBeforeCall(String garnishmentId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'garnishmentId' is set
        if (garnishmentId == null) {
            throw new ApiException("Missing the required parameter 'garnishmentId' when calling get(Async)");
        }

        return getCall(garnishmentId, xGustoAPIVersion, _callback);

    }


    private ApiResponse<Garnishment> getWithHttpInfo(String garnishmentId, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = getValidateBeforeCall(garnishmentId, xGustoAPIVersion, null);
        Type localVarReturnType = new TypeToken<Garnishment>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAsync(String garnishmentId, String xGustoAPIVersion, final ApiCallback<Garnishment> _callback) throws ApiException {

        okhttp3.Call localVarCall = getValidateBeforeCall(garnishmentId, xGustoAPIVersion, _callback);
        Type localVarReturnType = new TypeToken<Garnishment>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class GetRequestBuilder {
        ...
        private GetRequestBuilder(String garnishmentId) {
         ...
         */
        public Garnishment execute() throws ApiException {
            ApiResponse<Garnishment> localVarResp = getWithHttpInfo(garnishmentId, xGustoAPIVersion);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<Garnishment> executeWithHttpInfo() throws ApiException {
            return getWithHttpInfo(garnishmentId, xGustoAPIVersion);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Garnishment> _callback) throws ApiException {
            return getAsync(garnishmentId, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public GetRequestBuilder get(String garnishmentId) throws IllegalArgumentException {
        if (garnishmentId == null) throw new IllegalArgumentException("\"garnishmentId\" is required but got null");
            

        return new GetRequestBuilder(garnishmentId);
    }
    ...
    private okhttp3.Call updateCall(String garnishmentId, String xGustoAPIVersion, GarnishmentsUpdateRequest garnishmentsUpdateRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = garnishmentsUpdateRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateValidateBeforeCall(String garnishmentId, String xGustoAPIVersion, GarnishmentsUpdateRequest garnishmentsUpdateRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'garnishmentId' is set
        if (garnishmentId == null) {
            throw new ApiException("Missing the required parameter 'garnishmentId' when calling update(Async)");
        }

        return updateCall(garnishmentId, xGustoAPIVersion, garnishmentsUpdateRequest, _callback);

    }


    private ApiResponse<Garnishment> updateWithHttpInfo(String garnishmentId, String xGustoAPIVersion, GarnishmentsUpdateRequest garnishmentsUpdateRequest) throws ApiException {
        okhttp3.Call localVarCall = updateValidateBeforeCall(garnishmentId, xGustoAPIVersion, garnishmentsUpdateRequest, null);
        Type localVarReturnType = new TypeToken<Garnishment>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateAsync(String garnishmentId, String xGustoAPIVersion, GarnishmentsUpdateRequest garnishmentsUpdateRequest, final ApiCallback<Garnishment> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateValidateBeforeCall(garnishmentId, xGustoAPIVersion, garnishmentsUpdateRequest, _callback);
        Type localVarReturnType = new TypeToken<Garnishment>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class UpdateRequestBuilder {
        ...
        private UpdateRequestBuilder(String version, String garnishmentId) {
         ...
         * @return UpdateRequestBuilder
         */
        public UpdateRequestBuilder amount(Float amount) {
            this.amount = amount;
            return this;
        }
         ...
         * @return UpdateRequestBuilder
         */
        public UpdateRequestBuilder courtOrdered(Boolean courtOrdered) {
            this.courtOrdered = courtOrdered;
            return this;
        }
         ...
         * @return UpdateRequestBuilder
         */
        public UpdateRequestBuilder times(Integer times) {
            this.times = times;
            return this;
        }
         ...
         * @return UpdateRequestBuilder
         */
        public UpdateRequestBuilder recurring(Boolean recurring) {
            this.recurring = recurring;
            return this;
        }
         ...
         * @return UpdateRequestBuilder
         */
        public UpdateRequestBuilder annualMaximum(Float annualMaximum) {
            this.annualMaximum = annualMaximum;
            return this;
        }
         ...
         * @return UpdateRequestBuilder
         */
        public UpdateRequestBuilder payPeriodMaximum(Float payPeriodMaximum) {
            this.payPeriodMaximum = payPeriodMaximum;
            return this;
        }
         ...
         * @return UpdateRequestBuilder
         */
        public UpdateRequestBuilder deductAsPercentage(Boolean deductAsPercentage) {
            this.deductAsPercentage = deductAsPercentage;
            return this;
        }
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            GarnishmentsUpdateRequest garnishmentsUpdateRequest = buildBodyParams();
            return updateCall(garnishmentId, xGustoAPIVersion, garnishmentsUpdateRequest, _callback);
        }

        private GarnishmentsUpdateRequest buildBodyParams() {
            GarnishmentsUpdateRequest garnishmentsUpdateRequest = new GarnishmentsUpdateRequest();
            garnishmentsUpdateRequest.description(this.description);
            garnishmentsUpdateRequest.version(this.version);
            garnishmentsUpdateRequest.active(this.active);
            garnishmentsUpdateRequest.amount(this.amount);
            garnishmentsUpdateRequest.courtOrdered(this.courtOrdered);
            garnishmentsUpdateRequest.times(this.times);
            garnishmentsUpdateRequest.recurring(this.recurring);
            garnishmentsUpdateRequest.annualMaximum(this.annualMaximum);
            garnishmentsUpdateRequest.payPeriodMaximum(this.payPeriodMaximum);
            garnishmentsUpdateRequest.deductAsPercentage(this.deductAsPercentage);
            return garnishmentsUpdateRequest;
        }
        ...
        public Garnishment execute() throws ApiException {
            GarnishmentsUpdateRequest garnishmentsUpdateRequest = buildBodyParams();
            ApiResponse<Garnishment> localVarResp = updateWithHttpInfo(garnishmentId, xGustoAPIVersion, garnishmentsUpdateRequest);
            return localVarResp.getResponseBody();
        }
        ...
        public ApiResponse<Garnishment> executeWithHttpInfo() throws ApiException {
            GarnishmentsUpdateRequest garnishmentsUpdateRequest = buildBodyParams();
            return updateWithHttpInfo(garnishmentId, xGustoAPIVersion, garnishmentsUpdateRequest);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Garnishment> _callback) throws ApiException {
            GarnishmentsUpdateRequest garnishmentsUpdateRequest = buildBodyParams();
            return updateAsync(garnishmentId, xGustoAPIVersion, garnishmentsUpdateRequest, _callback);
        }
    }
     ...
     */
    public UpdateRequestBuilder update(String version, String garnishmentId) throws IllegalArgumentException {
        ...
        return new UpdateRequestBuilder(version, garnishmentId);
    }
}
