...
public class LocationsApiGenerated {
    ...
    private okhttp3.Call getDetailsCall(String locationId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDetailsValidateBeforeCall(String locationId, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'locationId' is set
        if (locationId == null) {
            throw new ApiException("Missing the required parameter 'locationId' when calling getDetails(Async)");
        }

        return getDetailsCall(locationId, xGustoAPIVersion, _callback);

    }


    private ApiResponse<Location> getDetailsWithHttpInfo(String locationId, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = getDetailsValidateBeforeCall(locationId, xGustoAPIVersion, null);
        Type localVarReturnType = new TypeToken<Location>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getDetailsAsync(String locationId, String xGustoAPIVersion, final ApiCallback<Location> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDetailsValidateBeforeCall(locationId, xGustoAPIVersion, _callback);
        Type localVarReturnType = new TypeToken<Location>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class GetDetailsRequestBuilder {
        ...
        private GetDetailsRequestBuilder(String locationId) {
         ...
         */
        public Location execute() throws ApiException {
            ApiResponse<Location> localVarResp = getDetailsWithHttpInfo(locationId, xGustoAPIVersion);
            return localVarResp.getResponseBody();
        }
         ...
         */
        public ApiResponse<Location> executeWithHttpInfo() throws ApiException {
            return getDetailsWithHttpInfo(locationId, xGustoAPIVersion);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Location> _callback) throws ApiException {
            return getDetailsAsync(locationId, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public GetDetailsRequestBuilder getDetails(String locationId) throws IllegalArgumentException {
        if (locationId == null) throw new IllegalArgumentException("\"locationId\" is required but got null");
            

        return new GetDetailsRequestBuilder(locationId);
    }
    ...
    private okhttp3.Call listCompanyLocationsCall(String companyId, Double page, Double per, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listCompanyLocationsValidateBeforeCall(String companyId, Double page, Double per, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling listCompanyLocations(Async)");
        }

        return listCompanyLocationsCall(companyId, page, per, xGustoAPIVersion, _callback);

    }


    private ApiResponse<List<Location>> listCompanyLocationsWithHttpInfo(String companyId, Double page, Double per, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = listCompanyLocationsValidateBeforeCall(companyId, page, per, xGustoAPIVersion, null);
        Type localVarReturnType = new TypeToken<List<Location>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listCompanyLocationsAsync(String companyId, Double page, Double per, String xGustoAPIVersion, final ApiCallback<List<Location>> _callback) throws ApiException {

        okhttp3.Call localVarCall = listCompanyLocationsValidateBeforeCall(companyId, page, per, xGustoAPIVersion, _callback);
        Type localVarReturnType = new TypeToken<List<Location>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class ListCompanyLocationsRequestBuilder {
        private final String companyId;
        private Double page;
        private Double per;
        private String xGustoAPIVersion;

        private ListCompanyLocationsRequestBuilder(String companyId) {
            this.companyId = companyId;
        }
         ...
         * @return ListCompanyLocationsRequestBuilder
         */
        public ListCompanyLocationsRequestBuilder page(Double page) {
            this.page = page;
            return this;
        }
         ...
         * @return ListCompanyLocationsRequestBuilder
         */
        public ListCompanyLocationsRequestBuilder per(Double per) {
            this.per = per;
            return this;
        }
         ...
         * @return ListCompanyLocationsRequestBuilder
         */
        public ListCompanyLocationsRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        
        /**
         * Build call for listCompanyLocations
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
        ...
        /**
         * Execute listCompanyLocations request
        ...
        public List<Location> execute() throws ApiException {
            ApiResponse<List<Location>> localVarResp = listCompanyLocationsWithHttpInfo(companyId, page, per, xGustoAPIVersion);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute listCompanyLocations request with HTTP info returned
        ...
        public ApiResponse<List<Location>> executeWithHttpInfo() throws ApiException {
            return listCompanyLocationsWithHttpInfo(companyId, page, per, xGustoAPIVersion);
        }

        /**
         * Execute listCompanyLocations request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<List<Location>> _callback) throws ApiException {
            return listCompanyLocationsAsync(companyId, page, per, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public ListCompanyLocationsRequestBuilder listCompanyLocations(String companyId) throws IllegalArgumentException {
        if (companyId == null) throw new IllegalArgumentException("\"companyId\" is required but got null");
            

        return new ListCompanyLocationsRequestBuilder(companyId);
    }
