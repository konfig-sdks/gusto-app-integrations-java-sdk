...
import com.konfigthis.client.model.EarningTypesUpdateTypeByIdRequest;
...
public class EarningTypesApiGenerated {
    ...
    private okhttp3.Call deactivateCall(String companyId, String earningTypeUuid, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deactivateValidateBeforeCall(String companyId, String earningTypeUuid, String xGustoAPIVersion, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
        ...
        if (earningTypeUuid == null) {
            throw new ApiException("Missing the required parameter 'earningTypeUuid' when calling deactivate(Async)");
        }

        return deactivateCall(companyId, earningTypeUuid, xGustoAPIVersion, _callback);

    }


    private ApiResponse<Void> deactivateWithHttpInfo(String companyId, String earningTypeUuid, String xGustoAPIVersion) throws ApiException {
        okhttp3.Call localVarCall = deactivateValidateBeforeCall(companyId, earningTypeUuid, xGustoAPIVersion, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call deactivateAsync(String companyId, String earningTypeUuid, String xGustoAPIVersion, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deactivateValidateBeforeCall(companyId, earningTypeUuid, xGustoAPIVersion, _callback);
    ...
    public class DeactivateRequestBuilder {
        ...
        private DeactivateRequestBuilder(String companyId, String earningTypeUuid) {
            this.companyId = companyId;
         ...
         */
        public DeactivateRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        ...
        public void execute() throws ApiException {
            deactivateWithHttpInfo(companyId, earningTypeUuid, xGustoAPIVersion);
        }
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return deactivateWithHttpInfo(companyId, earningTypeUuid, xGustoAPIVersion);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return deactivateAsync(companyId, earningTypeUuid, xGustoAPIVersion, _callback);
        }
    }
     ...
     */
    public DeactivateRequestBuilder deactivate(String companyId, String earningTypeUuid) throws IllegalArgumentException {
        if (companyId == null) throw new IllegalArgumentException("\"companyId\" is required but got null");
        ...
        return new DeactivateRequestBuilder(companyId, earningTypeUuid);
    }
    ...
    private okhttp3.Call updateTypeByIdCall(String companyId, String earningTypeUuid, String xGustoAPIVersion, EarningTypesUpdateTypeByIdRequest earningTypesUpdateTypeByIdRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = earningTypesUpdateTypeByIdRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateTypeByIdValidateBeforeCall(String companyId, String earningTypeUuid, String xGustoAPIVersion, EarningTypesUpdateTypeByIdRequest earningTypesUpdateTypeByIdRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'companyId' is set
        if (companyId == null) {
            throw new ApiException("Missing the required parameter 'companyId' when calling updateTypeById(Async)");
        }

        // verify the required parameter 'earningTypeUuid' is set
        if (earningTypeUuid == null) {
            throw new ApiException("Missing the required parameter 'earningTypeUuid' when calling updateTypeById(Async)");
        }

        return updateTypeByIdCall(companyId, earningTypeUuid, xGustoAPIVersion, earningTypesUpdateTypeByIdRequest, _callback);

    }


    private ApiResponse<EarningType> updateTypeByIdWithHttpInfo(String companyId, String earningTypeUuid, String xGustoAPIVersion, EarningTypesUpdateTypeByIdRequest earningTypesUpdateTypeByIdRequest) throws ApiException {
        okhttp3.Call localVarCall = updateTypeByIdValidateBeforeCall(companyId, earningTypeUuid, xGustoAPIVersion, earningTypesUpdateTypeByIdRequest, null);
        Type localVarReturnType = new TypeToken<EarningType>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateTypeByIdAsync(String companyId, String earningTypeUuid, String xGustoAPIVersion, EarningTypesUpdateTypeByIdRequest earningTypesUpdateTypeByIdRequest, final ApiCallback<EarningType> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateTypeByIdValidateBeforeCall(companyId, earningTypeUuid, xGustoAPIVersion, earningTypesUpdateTypeByIdRequest, _callback);
        Type localVarReturnType = new TypeToken<EarningType>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class UpdateTypeByIdRequestBuilder {
        private final String companyId;
        private final String earningTypeUuid;
        private String name;
        private String xGustoAPIVersion;

        private UpdateTypeByIdRequestBuilder(String companyId, String earningTypeUuid) {
            this.companyId = companyId;
            this.earningTypeUuid = earningTypeUuid;
        }
         ...
         * @return UpdateTypeByIdRequestBuilder
         */
        public UpdateTypeByIdRequestBuilder name(String name) {
            this.name = name;
            return this;
        }
         ...
         * @return UpdateTypeByIdRequestBuilder
         */
        public UpdateTypeByIdRequestBuilder xGustoAPIVersion(String xGustoAPIVersion) {
            this.xGustoAPIVersion = xGustoAPIVersion;
            return this;
        }
        
        /**
         * Build call for updateTypeById
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            EarningTypesUpdateTypeByIdRequest earningTypesUpdateTypeByIdRequest = buildBodyParams();
            return updateTypeByIdCall(companyId, earningTypeUuid, xGustoAPIVersion, earningTypesUpdateTypeByIdRequest, _callback);
        }

        private EarningTypesUpdateTypeByIdRequest buildBodyParams() {
            EarningTypesUpdateTypeByIdRequest earningTypesUpdateTypeByIdRequest = new EarningTypesUpdateTypeByIdRequest();
            earningTypesUpdateTypeByIdRequest.name(this.name);
            return earningTypesUpdateTypeByIdRequest;
        }

        /**
         * Execute updateTypeById request
         * @return EarningType
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public EarningType execute() throws ApiException {
            EarningTypesUpdateTypeByIdRequest earningTypesUpdateTypeByIdRequest = buildBodyParams();
            ApiResponse<EarningType> localVarResp = updateTypeByIdWithHttpInfo(companyId, earningTypeUuid, xGustoAPIVersion, earningTypesUpdateTypeByIdRequest);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute updateTypeById request with HTTP info returned
         * @return ApiResponse&lt;EarningType&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
        ...
        public ApiResponse<EarningType> executeWithHttpInfo() throws ApiException {
            EarningTypesUpdateTypeByIdRequest earningTypesUpdateTypeByIdRequest = buildBodyParams();
            return updateTypeByIdWithHttpInfo(companyId, earningTypeUuid, xGustoAPIVersion, earningTypesUpdateTypeByIdRequest);
        }

        /**
         * Execute updateTypeById request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
        ...
        public okhttp3.Call executeAsync(final ApiCallback<EarningType> _callback) throws ApiException {
            EarningTypesUpdateTypeByIdRequest earningTypesUpdateTypeByIdRequest = buildBodyParams();
            return updateTypeByIdAsync(companyId, earningTypeUuid, xGustoAPIVersion, earningTypesUpdateTypeByIdRequest, _callback);
        }
    }
     ...
     */
    public UpdateTypeByIdRequestBuilder updateTypeById(String companyId, String earningTypeUuid) throws IllegalArgumentException {
        if (companyId == null) throw new IllegalArgumentException("\"companyId\" is required but got null");
        ...
        return new UpdateTypeByIdRequestBuilder(companyId, earningTypeUuid);
    }
}
