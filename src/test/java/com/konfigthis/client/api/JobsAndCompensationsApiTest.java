...
public class JobsAndCompensationsApiTest {
     ...
     */
    @Test
    public void deleteCompensationTest() throws ApiException {
     ...
     */
    @Test
    public void deleteSpecificJobTest() throws ApiException {
        String jobId = null;
        String xGustoAPIVersion = null;
        api.deleteSpecificJob(jobId)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getCompensationsByJobIdTest() throws ApiException {
        String jobId = null;
        Double page = null;
        Double per = null;
        String include = null;
        String xGustoAPIVersion = null;
        List<Compensation> response = api.getCompensationsByJobId(jobId)
                .page(page)
                .per(per)
                .include(include)
                .xGustoAPIVersion(xGustoAPIVersion)
    ...
    public void getDetailsTest() throws ApiException {
        ...
        String include = null;
        String xGustoAPIVersion = null;
        Job response = api.getDetails(jobId)
                .include(include)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
