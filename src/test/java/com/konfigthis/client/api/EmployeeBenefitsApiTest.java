...
public class EmployeeBenefitsApiTest {
    ...
    public void createBenefitTest() throws ApiException {
        ...
        EmployeeBenefitsCreateBenefitRequestContribution contribution = null;
        ...
        EmployeeBenefit response = api.createBenefit(companyBenefitUuid, employeeId)
                .active(active)
    ...
    public void getByIdTest() throws ApiException {
        ...
        String xGustoAPIVersion = null;
        EmployeeBenefit response = api.getById(employeeBenefitId)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
    ...
    public void removeBenefitTest() throws ApiException {
        String employeeBenefitId = null;
        String xGustoAPIVersion = null;
        api.removeBenefit(employeeBenefitId)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateBenefitTest() throws ApiException {
        ...
        Boolean deductAsPercentage = null;
        String employeeDeductionAnnualMaximum = null;
        EmployeeBenefitsUpdateBenefitRequestContribution contribution = null;
        Boolean elective = null;
        String companyContributionAnnualMaximum = null;
        String limitOption = null;
        Boolean catchUp = null;
        ...
        Boolean contributeAsPercentage = null;
        String xGustoAPIVersion = null;
        EmployeeBenefit response = api.updateBenefit(version, employeeBenefitId)
                .active(active)
                .employeeDeduction(employeeDeduction)
                .deductAsPercentage(deductAsPercentage)
                .employeeDeductionAnnualMaximum(employeeDeductionAnnualMaximum)
