...
public class EarningTypesApiTest {
    ...
    public void deactivateTest() throws ApiException {
        ...
        String xGustoAPIVersion = null;
        api.deactivate(companyId, earningTypeUuid)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateTypeByIdTest() throws ApiException {
        String companyId = null;
        String earningTypeUuid = null;
        String name = null;
        String xGustoAPIVersion = null;
        EarningType response = api.updateTypeById(companyId, earningTypeUuid)
                .name(name)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
