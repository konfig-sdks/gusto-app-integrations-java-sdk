...
public class LocationsApiTest {
    ...
    public void getDetailsTest() throws ApiException {
        ...
        String xGustoAPIVersion = null;
        Location response = api.getDetails(locationId)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listCompanyLocationsTest() throws ApiException {
        String companyId = null;
        Double page = null;
        Double per = null;
        String xGustoAPIVersion = null;
        List<Location> response = api.listCompanyLocations(companyId)
                .page(page)
                .per(per)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
