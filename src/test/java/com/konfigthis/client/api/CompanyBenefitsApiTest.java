...
public class CompanyBenefitsApiTest {
     ...
     */
    @Test
    public void createCompanyBenefitTest() throws ApiException {
        ...
        CompanyBenefit response = api.createCompanyBenefit(description, companyId)
     ...
     */
    @Test
    public void getAllSupportedBenefitsTest() throws ApiException {
        String xGustoAPIVersion = null;
        List<SupportedBenefit> response = api.getAllSupportedBenefits()
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getByCompanyIdTest() throws ApiException {
        String companyId = null;
        Boolean enrollmentCount = null;
        String xGustoAPIVersion = null;
        List<CompanyBenefit> response = api.getByCompanyId(companyId)
    ...
    public void getByIdTest() throws ApiException {
        ...
        String xGustoAPIVersion = null;
        CompanyBenefitWithEmployeeBenefits response = api.getById(companyBenefitId)
     ...
     */
    @Test
    public void getFieldsRequirementsByIdTest() throws ApiException {
        String benefitId = null;
        String xGustoAPIVersion = null;
        BenefitTypeRequirements response = api.getFieldsRequirementsById(benefitId)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getSummaryByIdTest() throws ApiException {
        String companyBenefitId = null;
        String startDate = null;
        String endDate = null;
        Boolean detailed = null;
        String xGustoAPIVersion = null;
        BenefitSummary response = api.getSummaryById(companyBenefitId)
                .startDate(startDate)
                .endDate(endDate)
                .detailed(detailed)
                .xGustoAPIVersion(xGustoAPIVersion)
     ...
     */
    @Test
    public void removeBenefitTest() throws ApiException {
        String companyBenefitId = null;
        String xGustoAPIVersion = null;
        api.removeBenefit(companyBenefitId)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
