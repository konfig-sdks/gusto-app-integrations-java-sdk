...
public class EmployeeAddressesApiTest {
     ...
     */
    @Test
    public void deleteEmployeeHomeAddressTest() throws ApiException {
        String homeAddressUuid = null;
        String xGustoAPIVersion = null;
        api.deleteEmployeeHomeAddress(homeAddressUuid)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void deleteEmployeeWorkAddressTest() throws ApiException {
        String workAddressUuid = null;
        String xGustoAPIVersion = null;
        api.deleteEmployeeWorkAddress(workAddressUuid)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
    ...
    public void getTest() throws ApiException {
        String workAddressUuid = null;
        String xGustoAPIVersion = null;
        EmployeeWorkAddress response = api.get(workAddressUuid)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
    ...
    public void getWorkAddressesTest() throws ApiException {
        String employeeId = null;
        String xGustoAPIVersion = null;
        List<EmployeeWorkAddress> response = api.getWorkAddresses(employeeId)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
