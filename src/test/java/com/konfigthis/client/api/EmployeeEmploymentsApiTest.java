...
public class EmployeeEmploymentsApiTest {
     ...
     */
    @Test
    public void deleteRehireTest() throws ApiException {
        String employeeId = null;
        String xGustoAPIVersion = null;
        api.deleteRehire(employeeId)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getRehireInfoTest() throws ApiException {
        String employeeId = null;
        String xGustoAPIVersion = null;
        Rehire response = api.getRehireInfo(employeeId)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listTerminationsForEmployeeTest() throws ApiException {
        String employeeId = null;
        String xGustoAPIVersion = null;
        List<Termination> response = api.listTerminationsForEmployee(employeeId)
                .xGustoAPIVersion(xGustoAPIVersion)
                .execute();
        // TODO: test validations
    }
